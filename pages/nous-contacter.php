        ...
        <section id="contact">
            ...
            <form id="form_contact" name="form_contact" action="http://gil83.fr/nolark/testforms.php" method="POST">
                <fieldset id="coordo">
                    ...
                    <div><label for="i_prenom">Votre prénom :</label> <input type="text" name="i_prenom" id="i_prenom" size="35" pattern="^[a-zA-Z�����������������������������������������������������ݟƌ\s\-]+$" required><div class="input-validation"></div></div>
                    ...
                    <div>
                        ...
                        <select name="lst_typeclient" id="lst_typeclient">
                            ...
                            <option value="2">Salarié du priv�</option>
